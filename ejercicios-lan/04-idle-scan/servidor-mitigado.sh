...
echo "=== Punto 04 LAN — MITIGADO (Zombie + Objetivo) ==="
sysctl_save net.ipv4.conf.all.rp_filter
sysctl_save "net.ipv4.conf.${LAN_DEV}.rp_filter"
sysctl_set net.ipv4.conf.all.rp_filter 1
sysctl_set "net.ipv4.conf.${LAN_DEV}.rp_filter" 1
echo "[+] Mitigación: rp_filter=1 (bloqueo SYN spoofed)"
