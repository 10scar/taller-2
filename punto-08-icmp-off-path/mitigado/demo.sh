...
init_compose "p08m" "docker-compose.yml"
...
section "08" "ICMP OFF-PATH" "MITIGADO"
...
sleep 2
blank_line
prompt_victim "10.9.0.20" "ip route get 10.9.0.30  (accept_redirects=0, tcp_mtu_probing=1)"
run_exec victima ip route get 10.9.0.30 2>/dev/null || true
echo "[+] Ruta estable — ICMP forjado ignorado"
