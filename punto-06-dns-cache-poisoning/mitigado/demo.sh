...
init_compose "p06m" "docker-compose.yml"
trap 'teardown_lab 2>/dev/null || true' EXIT

setup_lab
sleep 6

section "06" "DNS CACHE POISONING" "MITIGADO"
...
sleep 2
blank_line
prompt_server "10.9.0.53" "dig @10.9.0.53 test.ejemplo.com +short  # filtro anti-poison activo"
run_exec atacante dig @10.9.0.53 test.ejemplo.com +short +time=2
echo "[+] Caché DNS protegida — respuesta legítima preservada"
